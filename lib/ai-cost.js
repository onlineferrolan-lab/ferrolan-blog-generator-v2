...
// tokens (MTok). Es solo informativa para el medidor del dashboard.
//
// CÓMO ACTUALIZAR: cuando un proveedor cambie tarifas, edita PRICES_PER_MTOK
// y actualiza PRICES_LAST_REVIEWED. Fuentes oficiales:
//   Anthropic → https://www.anthropic.com/pricing
//   OpenAI    → https://openai.com/api/pricing
export const PRICES_LAST_REVIEWED = "2026-06-11";
